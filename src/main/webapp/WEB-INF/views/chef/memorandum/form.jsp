...
<acme:form>
	...
	<acme:input-textbox code="chef.memorandum.form.label.link" path="link"/>
	
	<acme:input-select code="chef.memorandum.form.label.fine-dish" path="finedishes">
...
<jstl:otherwise>
<acme:input-textbox code="authenticated.chef.form.label.report" path="report"/>
</jstl:otherwise>
</jstl:choose>
